...
function booking(source, span, name, phone, upunit, upstreet, upsuburb, updatetime, offunit, offstreet, offsuburb)
{
	...
	if(isOK == 9)
	{
		...
		xHRObject.send("c-name=" + name + "&c-phone=" + phone + "&up-unit=" + upunit + "&up-street=" + upstreet + "&up-suburb=" + upsuburb + "&up-datetime=" + newupdatetime.toString() + "&off-unit=" + offunit + "&off-street=" + offstreet + "&off-suburb=" + offsuburb + "&book-datetime=" + bookdatetime);
	}
	else
	{
